...
export function About() {
  ...
  return (
    ...
    >
      {/* === HEADER (disamakan dengan Projects) === */}
      <motion.div
      ...
      >
        ...
        <p className="text-muted-foreground max-w-2xl mx-auto">
          I'm a passionate Computer Science student at Universitas Lampung,
          currently in my 5th semester, with a strong focus on Artificial
          Intelligence. I'm driven by a desire to leverage technology and
          innovation to solve real-world problems and create meaningful impact.
        </p>
      </motion.div>
