...
export function Experiences() {
  const experiences = [
    ...
    },
    {
      ...
      company: "Kartika Wifi",
      period: "2024 - 2025",
      description:
        "Developed and maintained network monitoring tools and IoT-based solutions to improve service reliability at Kartika, a local Wi-Fi provider. Contributed to backend development and system optimization for real-time connectivity monitoring.",
